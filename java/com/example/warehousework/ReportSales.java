...
public class ReportSales extends AppCompatActivity {
        ...
        ValueEventListener vListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    if (furniture.status.equals("продано") ) {
    ...
    private void setonClickItem() {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(ReportSales.this, FurForSale.class); // передача на экран полной информации
    ...
    public void toGoListMeny2FromReportSale (View v) {
        Intent goListMeny2FromReportSale = new Intent(this, List_Meny2.class);
        startActivity(goListMeny2FromReportSale);
    }
}
